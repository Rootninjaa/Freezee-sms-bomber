...
while 1:#bir döngü olşsun
    system("cls||clear")#üstte oluşan şeyleri silsin ve daha hoş bir görünüm olsun
    print("""{}
    ...
    try:
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "hatali giriş yaptin. Tekrar deneyiniz.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        print(Fore.GREEN + "Telefon numarasini başinda +90 olmadan yaziniz: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        try:
            int(tel_no)
            ...
            while True:
                with ThreadPoolExecutor() as executor:#bu kod bizim mesaj atma işlemerimizi tek arametre ile yaptığımız ve daha hızlı olan kod
                    futures = [
                        ...
                        #bu açık kaynaklı projeyi geliştirirken kahvedünyası kodunu bug yarattığını gördüm bug ise diyelim 10 girdik bize 15 atıyordu bu şakanın tadını bozabilirdi
                    ...
                    wait(futures)
        except KeyboardInterrupt:#ctrl+c yaparsa çıksın
            system("cls||clear")
